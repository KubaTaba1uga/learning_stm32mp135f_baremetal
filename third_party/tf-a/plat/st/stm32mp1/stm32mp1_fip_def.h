...
#if STM32MP13
#define STM32MP_BL2_BASE (STM32MP_BL2_DTB_BASE + STM32MP_BL2_DTB_SIZE)
#endif /* STM32MP13 */
#if STM32MP15
#define STM32MP_BL2_BASE                                                       \
  (STM32MP_SEC_SYSRAM_BASE + STM32MP_SEC_SYSRAM_SIZE - STM32MP_BL2_SIZE)
#endif /* STM32MP15 */

#define STM32MP_BL2_RO_BASE STM32MP_BL2_BASE

#define STM32MP_BL2_RW_BASE (STM32MP_BL2_RO_BASE + STM32MP_BL2_RO_SIZE)

#if STM32MP13
#define STM32MP_BL2_RW_SIZE                                                    \
  (STM32MP_SYSRAM_BASE + STM32MP_SYSRAM_SIZE - STM32MP_BL2_RW_BASE)

#define STM32MP_BL2_DTB_BASE STM32MP_SEC_SYSRAM_BASE
#endif /* STM32MP13 */
#if STM32MP15
#define STM32MP_BL2_RW_SIZE                                                    \
  (STM32MP_SEC_SYSRAM_BASE + STM32MP_SEC_SYSRAM_SIZE - STM32MP_BL2_RW_BASE)

#define STM32MP_BL2_DTB_BASE (STM32MP_BL2_BASE - STM32MP_BL2_DTB_SIZE)
#endif /* STM32MP15 */

#define STM32MP_BL32_DTB_BASE STM32MP_SYSRAM_BASE

#define STM32MP_BL32_BASE (STM32MP_BL32_DTB_BASE + STM32MP_BL32_DTB_SIZE)
...
#define STM32MP_OPTEE_SIZE (STM32MP_BL2_DTB_BASE - STM32MP_OPTEE_BASE)
#endif
...
#endif /* STM32MP13 */
#if STM32MP15
#define STM32MP_FW_CONFIG_BASE                                                 \
  (STM32MP_SYSRAM_BASE + STM32MP_SYSRAM_SIZE - PAGE_SIZE)
#endif /* STM32MP15 */
#define STM32MP_HW_CONFIG_BASE (STM32MP_BL33_BASE + STM32MP_BL33_MAX_SIZE)
