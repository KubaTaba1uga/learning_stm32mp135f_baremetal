...
To use an I/O in a given configuration, the user has to proceed as follows:
  ...
  2. Select the type, pull-up/pull-down and output speed via the GPIOx_OTYPER,
     GPIOx_PUPDR and GPIOx_OSPEEDER registers, respectively.
  3. Configure the desired I/O as an alternate function in the GPIOx_MODER
     register.
...
int main(void) {
  /*
    TO-DO:
      1. Enable alternate function of PC0 and PB0.
